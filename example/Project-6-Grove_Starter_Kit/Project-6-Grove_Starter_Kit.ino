...
void Light_show()  //顯示光感測器讀數在OLED上
{
...
void Sound_show() //顯示聲音感測器讀數在OLED上
{
...
void Temp_show() //顯示溫度&濕度感測器讀數在OLED上
{
  int temp = 0, humid = 0;
...
void Pressure_show()  //顯示氣壓感測器讀數在OLED上
{
...
void Acele_show() //顯示三軸加速度計讀數在OLED上
{
  float ax, ay, az;
